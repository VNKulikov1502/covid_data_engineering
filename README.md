...
#### dags/covid_alerts_dag.py - анализирует данные с помощью SQL-запросов на Trino (сами запросы в dags/sql/) в слое dds и присылает alerts на целевые emails в случае обнаружения вспышек заболеваемости/смертности в процентном соотношении к населению страны.
