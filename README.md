...
#### Мы имитируем ежедневную обработку отчётов о заболеваемости и смертности от COVDID-19 населения по всему миру.
...
#### Внутри директории airflow/dags/scripts/ лежат PySpark скрипты для обработки по слоям, которые проводят очистку и трансформацию данных внутри слоев, где также создаются новые слои. Вызовом этих скриптов занимается DAG covid_to_s3.py
